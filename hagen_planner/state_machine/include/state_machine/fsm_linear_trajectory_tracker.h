#ifndef _LINEAR_TRAJECTORY_TRACKER
#define _LINEAR_TRAJECTORY_TRACKER
...
{
class FSMLinearTrajectoryTracker
{
private:
  /* ---------- flag ---------- */
  ...
  LinearMPCTrajectoryTracker::Ptr trajectroy_tracker;
...
public:
  FSMLinearTrajectoryTracker(/* args */)
  {
  }
