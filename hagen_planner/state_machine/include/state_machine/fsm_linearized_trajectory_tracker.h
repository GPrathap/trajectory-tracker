#ifndef FSM_LINEARIZED_TRAJECTORY_TRACKER
#define FSM_LINEARIZED_TRAJECTORY_TRACKER
...
{
class FSMLinearizedTrajectoryTracker
{
private:
  /* ---------- flag ---------- */
  ...
  LinearizedMPCTrajectoryTracker::Ptr trajectroy_tracker;
  ...
  ros::Publisher replan_pub_, course_pub, bspline_pub_, wait_for_goal, stat_moving, stop_moving, pos_cmd_pub, state_pub, waypoint_pub;
...
public:
  FSMLinearizedTrajectoryTracker(/* args */)
  {
  }
  ~FSMLinearizedTrajectoryTracker()
  {
  }
