...
void EllipsoidArrayDisplay::processMessage(const decom_ros_msgs::EllipsoidArray::ConstPtr &msg) {
...
PLUGINLIB_EXPORT_CLASS(decom_rviz_plugins::EllipsoidArrayDisplay, rviz::Display)
