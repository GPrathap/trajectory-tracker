...
#include <memory>
#include <decom_rviz_plugins/line_segment.h>
...
protected:
 template<int U = Dim>
   ...
   add_global_bbox(Polyhedron<Dim> &Vs) {
     ...
     //*** X
     Vs.add(Hyperplane2D(Eigen::Matrix<decimal_t, 2, 1>(global_bbox_max_(0), 0), Eigen::Matrix<decimal_t, 2, 1>(1, 0)));
     Vs.add(Hyperplane2D(Eigen::Matrix<decimal_t, 2, 1>(global_bbox_min_(0), 0), Eigen::Matrix<decimal_t, 2, 1>(-1, 0)));
     //*** Y
     Vs.add(Hyperplane2D(Eigen::Matrix<decimal_t, 2, 1>(0, global_bbox_max_(1)), Eigen::Matrix<decimal_t, 2, 1>(0, 1)));
     Vs.add(Hyperplane2D(Eigen::Matrix<decimal_t, 2, 1>(0, global_bbox_min_(1)), Eigen::Matrix<decimal_t, 2, 1>(0, -1)));
   }
 ...
 template<int U = Dim>
   ...
   add_global_bbox(Polyhedron<Dim> &Vs) {
     ...
     //*** Z
     Vs.add(Hyperplane3D(Eigen::Matrix<decimal_t, 3, 1>(0, 0, global_bbox_max_(2)), Eigen::Matrix<decimal_t, 3, 1>(0, 0, 1)));
     Vs.add(Hyperplane3D(Eigen::Matrix<decimal_t, 3, 1>(0, 0, global_bbox_min_(2)), Eigen::Matrix<decimal_t, 3, 1>(0, 0, -1)));

     //*** X
     Vs.add(Hyperplane3D(Eigen::Matrix<decimal_t, 3, 1>(global_bbox_max_(0), 0, 0), Eigen::Matrix<decimal_t, 3, 1>(1, 0, 0)));
     Vs.add(Hyperplane3D(Eigen::Matrix<decimal_t, 3, 1>(global_bbox_min_(0), 0, 0), Eigen::Matrix<decimal_t, 3, 1>(-1, 0, 0)));
     //*** Y
     Vs.add(Hyperplane3D(Eigen::Matrix<decimal_t, 3, 1>(0, global_bbox_max_(1), 0), Eigen::Matrix<decimal_t, 3, 1>(0, 1, 0)));
     Vs.add(Hyperplane3D(Eigen::Matrix<decimal_t, 3, 1>(0, global_bbox_max_(1), 0), Eigen::Matrix<decimal_t, 3, 1>(0, -1, 0)));
   }
